...
const CategoryDetailModal: React.FC<CategoryDetailModalProps> = ({ isOpen, category, onClose }) => {
  ...
  const fetchDetail = async () => {
    try {
      ...
      toast.error(t('categories.modal.detail.errorLoad'));
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="bg-white dark:bg-neutral-900 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-neutral-700 sticky top-0 bg-white dark:bg-neutral-900">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">
            {t('categories.modal.detail.title')}
          </h3>
          <button
            onClick={onClose}
          ...
          <div className="p-6 space-y-6 overflow-y-auto flex-1">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 text-center">
                ...
                <div className="text-xs text-gray-600 dark:text-gray-400">{t('categories.modal.detail.notes')}</div>
              </div>
              <div className="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 text-center">
                ...
                <div className="text-xs text-gray-600 dark:text-gray-400">{t('categories.modal.detail.color')}</div>
              </div>
              <div className="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 text-center">
                ...
                <div className="text-xs text-gray-600 dark:text-gray-400">{t('categories.modal.detail.icon')}</div>
              </div>
            </div>
            ...
            <div className="border-t border-gray-200 dark:border-neutral-700 pt-4">
              <h5 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">
                {t('categories.modal.detail.userInfo')}
              </h5>
            ...
            <div className="border-t border-gray-200 dark:border-neutral-700 pt-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="text-gray-600 dark:text-gray-400 mb-1">{t('categories.modal.detail.createdAt')}</p>
                ...
                <div>
                  <p className="text-gray-600 dark:text-gray-400 mb-1">{t('categories.modal.detail.updatedAt')}</p>
                  <div className="flex items-center gap-2 text-gray-900 dark:text-gray-100">
                    <Calendar className="w-4 h-4" />
            ...
            {detail.sampleNotes && detail.sampleNotes.length > 0 && (
              <div className="border-t border-gray-200 dark:border-neutral-700 pt-4">
                <h5 className="font-semibold text-gray-900 dark:text-gray-100 mb-3">
                  {t('categories.modal.detail.sampleNotes')} ({detail.sampleNotes.length})
                </h5>
        ...
        <div className="p-4 border-t border-gray-200 dark:border-neutral-700">
          ...
          >
            {t('categories.modal.detail.close')}
          </button>
        </div>
      </div>
    </div>
